...
import tracteurImg from '@/public/images/tracteur.png';
    ...
    <div className="min-h-screen bg-surface-2 flex flex-col">
      ...
      <main className="flex-1 pb-24 md:pb-8">
        ...
        <div className="relative w-full overflow-hidden" style={{ height: 'clamp(180px, 30vw, 320px)' }}>
          <Image
            src="/images/hero_materiel_v2.webp"
            ...
            <div className="max-w-6xl mx-auto w-full px-4 pt-10 pb-5 md:pt-16 md:pb-8">
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <h1 className="text-2xl md:text-4xl font-black text-white drop-shadow">{t('nav.equipment')}</h1>
                  <p className="text-white/65 text-xs md:text-sm mt-0.5">{t('explore.title_materiel')}</p>
                </div>
                {estAgriculteur && (
                  <Link href="/vendre?mode=EQUIPMENT"

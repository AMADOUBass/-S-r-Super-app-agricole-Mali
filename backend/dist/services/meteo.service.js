...
exports.getMeteoParCommune = void 0;
...
const getDescriptionMeteo = (code) => {
    if (code === 0)
        return 'Ciel dégagé';
    if (code <= 2)
...
// ─────────────────────────────────────────────────────────────
const getMeteoParCommune = async (commune) => {
...
exports.getMeteoParCommune = getMeteoParCommune;

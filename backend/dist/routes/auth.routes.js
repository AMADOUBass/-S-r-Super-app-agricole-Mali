...
const schemaInscription = zod_1.z.object({
    telephone: zod_1.z.string().regex(/^\+223\d{8}$/, 'Numéro malien requis (+223XXXXXXXX)'),
...
const schemaVerification = zod_1.z.object({
    telephone: zod_1.z.string().regex(/^\+223\d{8}$/),
...
const schemaEmailInscription = zod_1.z.object({
    ...
    telephone: zod_1.z.string().regex(/^\+223\d{8}$/).optional(),
});
// POST /auth/register
